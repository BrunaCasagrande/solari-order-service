...
import br.com.solari.application.dto.AddressDTO;
...
public final class OrderFixture {
  ...
  public static final PaymentData PAYMENT_DATA =
      new PaymentData(PaymentMethod.CREDIT_CARD, "123456789");
  public static final Map<String, Integer> PRODUCTS =
      Map.of(
          "1", 2,
          "2", 3);
  ...
  public static Order createOrderExemple() {
    return Order.createOrder(ID, PRODUCTS, CPF, "CREDIT_CARD", "987654321987654312");
  }

  public static OrderEvent createOrderEventExemple() {
    return new OrderEvent(ID, PRODUCTS, CPF, PAYMENT_DATA);
  }
  ...
  public static ClientDTO createClientDTOExemple() {
    AddressDTO AddressDTO =
        new AddressDTO(1, "rua teste", "1", "São Paulo", "São Paulo", "03966100");

    return new ClientDTO(1, "Bruna Teste", CPF, "11 977785522", "teste@gmail.com", AddressDTO);
  }
