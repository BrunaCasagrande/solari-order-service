...
public class OrderTest {
  ...
  void shouldNotCreateWhenIdIsInvalid(final String emptyId) {
    assertThatThrownBy(
            () ->
                Order.createOrder(
                    emptyId, PRODUCTS, "12345678900", "CREDIT_CARD", "987654321987654312"))
  ...
  @NullAndEmptySource
  @ValueSource(strings = {" "})
  void shouldNotCreateWhenPaymentIdentificationIsInvalid(
      final String invalidPaymentIdentification) {
    assertThatThrownBy(
            () ->
                Order.createOrder(
                    "3b035f13-80d0-4af0-9f27-5314f8ad8a8d",
